...
6.（必做）基于电商交易场景（用户、商品、订单），设计一套简单的表结构，提交 DDL 的 SQL 文件到 Github（后面 2 周的作业依然要是用到这个表结构）。
  - Answer: [task 06 solution](https://github.com/ajdfajdfl2003/JAVA-003/tree/main/Week_06/task06)
...
以上作业，要求 1 道必做题目提交到 GitHub 上面，然后把自己的作业链接填写到下方的表单里面：

- https://jinshuju.net/f/PRlWx8

作业提交截止时间 6 月 6 日（周日）23:49 前。
