...
public class UsingProxy {
    ...
    public static void main(String[] args) throws DataAccessException {
        ...
        log.info(query_order_detail());
    }

    private static List<Order> query_order() throws DataAccessException {
    ...
    private static List<OrderDetail> query_order_detail() throws DataAccessException {
