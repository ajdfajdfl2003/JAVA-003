...
2.（必做）思考有多少种方式，在 main 函数启动一个新线程，运行一个方法，拿到这个方法的返回值后，退出主线程? 写出你的方法，越多越好，提交到 GitHub。
  ...
  - Answer: [task 02 solution](https://github.com/ajdfajdfl2003/JAVA-003/tree/main/Week_04/task02)
...
6.（必做）把多线程和并发相关知识梳理一遍，画一个脑图，截图上传到 GitHub 上。 可选工具:xmind，百度脑图，wps，MindManage，或其他。
  - Answer: [task 06 solution](https://github.com/ajdfajdfl2003/JAVA-003/tree/main/Week_04/task06)
